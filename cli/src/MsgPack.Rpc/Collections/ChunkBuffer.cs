...
namespace MsgPack.Collections
{
	...
	///		Represents buffer.
	/// </summary>
	public abstract class ChunkBuffer : IList<ArraySegment<byte>>, IDisposable//, IClippable
	{
		/// <summary>
		...
		public static ChunkBuffer CreateDefault( int initialSegmentCount, int segmentSize )
		{
			...
			return new GCChunkBuffer( initialSegments, segmentSize, initialSegmentCount * segmentSize );
		}
		...
		[Obsolete( "Use Fill(IEnumerable<byte>) instead." )]
		...
		/// <summary>
		///		Fill this buffer by specified binaries.
		/// </summary>
		/// <param name="values">
		...
		/// <remarks>
		///		Binary will be filled from head of this buffer.
		/// </remarks>
		...
		/// </summary>
		/// <param name="values">
		///		Content to be filled. This value will not be null.
		/// </param>
		/// <remarks>
		///		Binary will be filled from head of this buffer.
		/// </remarks>		
		protected abstract void FillCore( IEnumerable<byte> values );
